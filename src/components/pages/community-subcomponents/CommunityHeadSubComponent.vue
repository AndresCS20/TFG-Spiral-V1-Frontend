    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <button class="btn btn-primary" @click="joinCommunity" v-if="!isMember"><i class="fa-solid fa-door-open"></i>&nbsp;Unirse</button>
          <button class="btn btn-danger me-2" @click="leaveCommunity" v-if="isMember && !isStaff"><i class="fa-solid fa-door-closed"></i> Salirse</button>
          <button class="btn btn-info mx-2" v-if="isMember && isStaff"><i class="fa-solid fa-pen-to-square"></i>Editar</button>
          <button class="btn btn-danger ms-2" v-if="isMember && isStaff"><i class="fa-solid fa-delete-right"></i>Borrar Comunidad</button>
          <button class="btn btn-warning ms-2" v-if="isMember && isStaff"><i class="fa-solid fa-person-booth"></i> Cambiar Admin</button>
        </div>
      </div>
    </div>
  </div>
