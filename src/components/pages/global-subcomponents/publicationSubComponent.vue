<template>
    <div class="card rounded" v-for="publication in publicationList" :key="publication.id">
   <div class="card-body">
                        <div class="d-flex align-items-center gap-3"><img :src="publication.profile_pic" alt="" class="rounded-circle" width="40" height="40">
                  ...
                  {{ publication.contenido }}
                        ...
                        <div class="d-flex align-items-center my-3">
                            <div class="d-flex align-items-center gap-2"><a
                                    ...
                                    data-bs-title="Like"><i class="fa-solid fa-thumbs-up"></i></a><span
                                    class="fw-semibold">67 Reacciones</span></div>
                            <div class="d-flex align-items-center gap-2 ms-4"><a
                                    ...
                                    href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="Comment"><i class="fa-solid fa-message"></i></a><span
                                    class="fw-semibold">2 Comentarios</span></div><a
                        ...
                        <div class="position-relative">
                            <div class="p-4 rounded-2 border border-dark-subtle mb-3">
                                ...
                                <p class="mt-3 mb-0">Lorem ipsum dolor sit amet consectetur, adipiscing elit mattis
                                    pharetra scelerisque, porta blandit erat laoreet. Sodales placerat phasellus congue
                                    parturient odio curae mus, tristique ullamcorper taciti vestibulum dictum netus
                                    euismod, enim dis risus et feugiat integer. </p>
                            </div>
                            <div class="p-4 rounded-2 border border-dark-subtle mb-3">
                                <div class="d-flex align-items-center gap-3"><img
                                ...
                                <p class="mt-3 mb-0">Lorem ipsum dolor sit amet consectetur, adipiscing elit mattis
                                    pharetra scelerisque, porta blandit erat laoreet. Sodales placerat phasellus congue
                                    parturient odio curae mus, tristique ullamcorper taciti vestibulum dictum netus
                                    euismod, enim dis risus et feugiat integer.<br><br>Lorem ipsum dolor sit amet
                                    consectetur, adipiscing elit mattis pharetra scelerisque, porta blandit erat
                                    laoreet. Sodales placerat phasellus congue parturient odio curae mus, tristique
                                    ullamcorper taciti vestibulum dictum netus euismod, enim dis risus et feugiat
                                    integer. </p>
                            </div>
                        </div>
                    </div>
